...
public class mainHome extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       EditprofileGetdata();
        ...
        viewpageuserAdapter.AddFragment(new FragmentUserView(), "view User");
        viewpageuserAdapter.AddFragment(new FragmentUserAdd(), "Add User");
...
//
    ...
    private void uploadTofirebase(Uri imageuri, String stringusername, String stringpassword) {
        ...
        fileRef.putFile(imageuri).addOnSuccessListener(taskSnapshot -> fileRef.getDownloadUrl().addOnSuccessListener(uri -> {
            ...
            progressBar.setVisibility(View.VISIBLE);
            Toast.makeText(mainHome.this, "Uploading Failure.....", Toast.LENGTH_SHORT).show();
        });
    }
